...
public class BlindPriorityParser implements TagParser {
    ...
    protected EnumEncodedValue<RouteNetwork> blindRouteEnc;
    protected Map<RouteNetwork, Integer> routeMap = new HashMap<>();

    public BlindPriorityParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getDecimalEncodedValue(VehiclePriority.key(properties.getString("name", "blind"))),
                lookup.getEnumEncodedValue(FootNetwork.KEY, RouteNetwork.class)
        );
    }

    protected BlindPriorityParser(DecimalEncodedValue priorityEnc, EnumEncodedValue<RouteNetwork> blindRouteEnc) {
        this.blindRouteEnc = blindRouteEnc;
    ...
    public void handleWayTags(int edgeId, EdgeIntAccess edgeIntAccess, ReaderWay way, IntsRef relationFlags) {
        ...
        Integer priorityFromRelation = routeMap.get(blindRouteEnc.getEnum(false, edgeId, edgeIntAccess));
