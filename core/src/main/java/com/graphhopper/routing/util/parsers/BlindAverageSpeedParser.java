...
public class BlindAverageSpeedParser extends AbstractAverageSpeedParser implements TagParser {
    ...
    public BlindAverageSpeedParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getDecimalEncodedValue(VehicleSpeed.key(properties.getString("name", "blind"))));
    }

    protected BlindAverageSpeedParser(DecimalEncodedValue speedEnc) {
