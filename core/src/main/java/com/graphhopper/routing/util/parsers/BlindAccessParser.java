...
public class BlindAccessParser extends AbstractAccessParser implements TagParser {
    ...
    public BlindAccessParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getBooleanEncodedValue(VehicleAccess.key(properties.getString("name", "blind"))));
        blockPrivate(properties.getBool("block_private", true));
        blockFords(properties.getBool("block_fords", false));
    }

    protected BlindAccessParser(BooleanEncodedValue accessEnc) {
