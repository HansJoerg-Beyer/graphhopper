...
public class RollatorPriorityParser extends FootPriorityParser {

    public RollatorPriorityParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getDecimalEncodedValue(properties.getString("name", VehiclePriority.key("rollator"))),
                lookup.getEnumEncodedValue(FootNetwork.KEY, RouteNetwork.class));
    }

    protected RollatorPriorityParser(DecimalEncodedValue priorityEnc, EnumEncodedValue<RouteNetwork> footRouteEnc) {
