...
public class RollatorAccessParser extends FootAccessParser {
    ...
    public RollatorAccessParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getBooleanEncodedValue(properties.getString("name", VehicleAccess.key("rollator"))));
        blockPrivate(properties.getBool("block_private", true));
        blockFords(properties.getBool("block_fords", false));
    }

    protected RollatorAccessParser(BooleanEncodedValue accessEnc) {
        super(accessEnc);

        restrictions.add("rollator");
