 ...
 * @author don-philipe
 */
public class RollatorTagParserTest {
    private final BooleanEncodedValue rollatorAccessEnc;
    private final DecimalEncodedValue rollatorAvSpeedEnc;
    private final DecimalEncodedValue rollatorPriorityEnc;
    private final BooleanEncodedValue carAccessEnc;
    private final DecimalEncodedValue carAvSpeedEnc;
    private final EncodingManager encodingManager;
    private final RollatorAccessParser accessParser;
    private final RollatorAverageSpeedParser speedParser;
    private final RollatorPriorityParser prioParser;

    public RollatorTagParserTest() {
        rollatorAccessEnc = VehicleAccess.create("rollator");
        rollatorAvSpeedEnc = VehicleSpeed.create("rollator", 4, 1, true);
        rollatorPriorityEnc = VehiclePriority.create("rollator", 4, PriorityCode.getFactor(1), false);
        ...
        encodingManager = EncodingManager.start()
                .add(rollatorAccessEnc).add(rollatorAvSpeedEnc).add(rollatorPriorityEnc).add(RouteNetwork.create(FootNetwork.KEY))
                .add(carAccessEnc).add(carAvSpeedEnc)
                .build();
        accessParser = new RollatorAccessParser(encodingManager, new PMap());
        accessParser.init(new DateRangeParser());
        speedParser = new RollatorAverageSpeedParser(encodingManager, new PMap()) {
            @Override
        ...
        prioParser = new RollatorPriorityParser(encodingManager, new PMap());
    }
    ...
    public void testGetSpeed() {
        ...
        int edgeId = 0;
        rollatorAccessEnc.setBool(false, edgeId, edgeIntAccess, true);
        rollatorAccessEnc.setBool(true, edgeId, edgeIntAccess, true);
        rollatorAvSpeedEnc.setDecimal(false, edgeId, edgeIntAccess, 10);
        assertEquals(10, rollatorAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess), .1);
    }
    ...
    public void testCombined() {
        ...
        edge.set(rollatorAvSpeedEnc, 10.0).set(rollatorAccessEnc, true, true);
        edge.set(carAvSpeedEnc, 100.0).set(carAccessEnc, true, false);

        assertEquals(10, edge.get(rollatorAvSpeedEnc), .1);
        assertTrue(edge.get(rollatorAccessEnc));
        assertTrue(edge.getReverse(rollatorAccessEnc));
    ...
    public void testGraph() {
        BaseGraph g = new BaseGraph.Builder(encodingManager).create();
        g.edge(0, 1).setDistance(10).set(rollatorAvSpeedEnc, 10.0).set(rollatorAccessEnc, true, true);
        g.edge(0, 2).setDistance(10).set(rollatorAvSpeedEnc, 5.0).set(rollatorAccessEnc, true, true);
        g.edge(1, 3).setDistance(10).set(rollatorAvSpeedEnc, 10.0).set(rollatorAccessEnc, true, true);
    ...
    public void testPier() {
        ...
        assertTrue(rollatorAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertTrue(rollatorAccessEnc.getBool(true, edgeId, edgeIntAccess));
        assertEquals(5, rollatorAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess));
    }
    ...
    public void testMixSpeedAndSafe() {
        ...
        int edgeId = 0;
        accessParser.handleWayTags(edgeId, edgeIntAccess, way, null);
        assertFalse(rollatorAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertFalse(rollatorAccessEnc.getBool(true, edgeId, edgeIntAccess));
        ...
        assertTrue(rollatorAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertTrue(rollatorAccessEnc.getBool(true, edgeId, edgeIntAccess));
        assertEquals(5, rollatorAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess), .1);
    ...
    public void testApplyWayTags() {
        ...
        GHUtility.setSpeed(5, 5, rollatorAccessEnc, rollatorAvSpeedEnc, edge01);
        ...
        GHUtility.setSpeed(5, 5, rollatorAccessEnc, rollatorAvSpeedEnc, edge23);
        ...
        GHUtility.setSpeed(5, 5, rollatorAccessEnc, rollatorAvSpeedEnc, edge45);
        ...
        assertTrue(edge01.get(rollatorAccessEnc));
        assertTrue(edge01.getReverse(rollatorAccessEnc));
        assertEquals(2, edge01.get(rollatorAvSpeedEnc), 0);
        ...
        assertTrue(edge23.get(rollatorAccessEnc));
        assertTrue(edge23.getReverse(rollatorAccessEnc));
        ...
        assertEquals(0, edge45.get(rollatorAvSpeedEnc), 0.1);
        assertEquals(0, edge45.getReverse(rollatorAvSpeedEnc), 0.1);
    }
}
